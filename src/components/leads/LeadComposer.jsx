    ...
    <div className="rounded-2xl border border-stone-200 bg-white p-4 shadow-sm">
      ...
      {showFilters && (
        <><div className="mt-3 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5">
          ...
          <label className="block"><span className="text-[10.5px] font-medium text-stone-500 mb-1 block">Result mode</span><select value={filters.match_mode} onChange={(e) => setFilters({ ...filters, match_mode: e.target.value })} className="w-full rounded-lg border border-stone-200 px-2.5 py-2 text-[12.5px]"><option value="strict">Strict matches</option><option value="near">Near matches</option><option value="all">All with notes</option></select></label>
